...
- Key Features:
  - **PHY**: KSZ9031/KSZ9131 網路晶片
  - **RGMII**: 傳送資料
  - **MDIO**: 類似i2c更改KSZ9031/KSZ9131的register
  - **MAC**: 電腦收資料的晶片
...
- **IP Address**:
  - uboot `ipaddr 192.168.1.100`, `serverip 192.168.1.1`
...
## **6. skew**
[RGMII Interface Timing Considerations](https://ethernetfmc.com/docs/ethernet-fmc/rgmii-timing/)
...
### 兩個裝置對接
同時 negohation
因為negohation master 會送clk, slave會ack
